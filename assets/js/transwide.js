(function ($) {
  ...
  $(document).ready(function () {
    $(".projects-three__wrapper .projects-three__item").on(
      "mousemove",
      function () {
        $(".projects-three__wrapper .projects-three__item").removeClass(
          "active"
        );
  ...
  function thmOwlInit() {
    ...
    let transwideowlCarouselNav = $(".transwide-owl__carousel--custom-nav");
    ...
    let transwideowlCarouselCustomDots = $(
      ".transwide-owl__carousel--custom-dots"
    );
